...
| Roll back production | Release commit and Railway deployment metadata | Reviewed PR or Railway previous-deployment redeploy | Railway access, never exposed to responder | Release owner | Human approval |
